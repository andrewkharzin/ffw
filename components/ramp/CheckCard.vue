      ...
      <div class="grid grid-cols-2 gap-4">
        <div class="flex">
          ...
          <div class="flex flex-col">
            <div class="ml-0 p-2 grid grid-cols-2">
              <!-- <UIcon name="i-heroicons-calendar-days" size="20px" class="mt-1" /> -->
              <span class="uppercase text-sm font-sans font-normal dark:text-gray-400 text-slate-800">{{ convertDateFormat(check.data)}}</span>
            </div>
